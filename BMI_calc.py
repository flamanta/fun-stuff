class bmi_calc():
    ...
    def __init__(self, weight, height, units):
        '''Initialize BMI calculator object, with weight,
        height and system of units.'''
    ...
    def calc(self):
        '''Computes and prints out to stdout the user's
        BMI and health advice.'''
        ...
        if self.units == 'metric':
            try:
                ...
                print('Wrong input for either height or weight.',
            ...
            print("Use 'metric' for metric/SI units or 'imperial'",
                  "for imperial units.")
            return
    ...
    def print_calc(self, bmi):
        ...
        if bmi >= 27.5:
            ...
            print(f'Your BMI is {bmi}',
                  'and you are at risk of nutritional deficiency',
